		...
		<div class="sidebar sidebar-dark sidebar-main sidebar-expand-md">
			...
			<div class="sidebar-content">
				...
				<div class="card card-body">
					<a href="http://kopyov.ticksy.com" class="btn bg-success-400 btn-block" target="_blank"><i class="icon-lifebuoy mr-2"></i> Información </a>
				</div>
				<!-- /support -->
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Principal</div> <i class="icon-menu"></i></li>
						<li class="nav-item"><a href="index.html" class="nav-link active">Introduccion</a></li>
						<li class="nav-item"><a href="main_getting_started.html" class="nav-link">Novedades</a></li>
						<li class="nav-item"><a href="main_starter_kit.html" class="nav-link">Iniciar Kit</a></li>
		...
		<div class="page-header">
			<div class="page-header-content header-elements-md-inline">
				<div class="page-title d-flex">
					<h4><i class="icon-stack2"></i> <span class="font-weight-semibold">Cursos</span> - Capacitación</h4>
				...
				<div class="header-elements d-none py-0 mb-3 mb-md-0">
					<div class="breadcrumb">
						...
						<span class="breadcrumb-item active">Introducción</span>
					</div>
				</div>
			</div>
		</div>
